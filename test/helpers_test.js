...
describe("Helpers", () => {
    ...
    describe("#fixUrl()", () => {
        it("should properly convert urls", () => {
            ...
            assert.strictEqual(fixUrl("demo.memson"), "http://demo.memson/");
            assert.strictEqual(fixUrl("demo.memson/"), "http://demo.memson/");
            assert.strictEqual(fixUrl("demo.memson:8000"), "http://demo.memson:8000/");
            assert.strictEqual(fixUrl("https://demo.memson"), "https://demo.memson/");
            assert.strictEqual(fixUrl("https://demo.memson:8000"), "https://demo.memson:8000/");
        });
    });
});
